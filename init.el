...
(custom-set-variables
 ...
 '(package-selected-packages
   '(go-mode lsp-ivy lsp-treemacs lsp-ui lsp-mode tree-sitter-langs tree-sitter evil-magit magit counsel-projectile projectile hydra evil-collection evil general helpful counsel ivy-rich which-key rainbow-delimiters doom-themes doom-modeline all-the-icons ivy command-log-mode use-package))
